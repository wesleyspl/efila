            ...
            <table data-sortable="" class="table table-hover table-striped" data-sortable-initialized="true">
                ...
                <tbody>
                 ...
                 <tr>
                  ...
                  <td>{{$paineis->obs}}</td>
                  <td>
                    <a class="btn btn-info"  target="_blank"  href="{{ route('painel.show',$paineis->id_touch) }}"><i class="fa fa-eye"></i> Abrir painel</a>
                    <a class="btn btn-danger"  href="{{ route('painel.desativarPainel',$paineis->id_touch) }}"><i class="fa fa-trash-o"></i> Deletar</a>
