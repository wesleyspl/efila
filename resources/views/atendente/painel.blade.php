...
<div class="widget">
    ...
    <div class="widget-content padding">
        ...
        <a onclick="chamarProximo()" id="btn_inicia" class="btn btn-info btn-lg d-flex align-items-center justify-content-center gap-2">
            <span class="glyphicon glyphicon-play"></span> Iniciar Atendimento </a>
        </button>
